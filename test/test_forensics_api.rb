...
require_relative "../lib/ForensicsAPI/forensics_api"

module ForensicsAPI
	class ForensicsAPISpec < Minitest::Spec
        ...
        it 'returns 5 and 2 as x and y co-ordinates' do 
            ...
            locator.move_with_directions(directions)
        ...
        it 'returns 1 and 1 as x and y co-ordinates' do 
           locator = CatLocator.new
           locator.move_with_directions(new_directions)
        ...
        it 'returns 0 and 0 as x and y co-ordinates' do
           locator = CatLocator.new
           locator.move_with_directions(dont_move)
